...
public class TareaRepository : ITareaRepository
{
    ...
    {
        var query = $"INSERT INTO Tarea VALUES (@id, @idTablero, @nombre, @estado, @desc, @color, @idUserAsign)";
    ...
    {
        var query = $"UPDATE Tarea SET id = @id, id_tablero = @idTablero, nombre = @nombre, estado = @estado, descripcion = @desc, color = @color, id_usuario_asignado = @idUserAsign WHERE id = @idcambiar;";
        using (SQLiteConnection connection = new SQLiteConnection(cadenaConexion))
        {
            connection.Open();
            var command = new SQLiteCommand(query, connection);
    ...
    public List<Tarea> ListByEstado(EstadoTarea estado)
    {
        SQLiteConnection connection = new SQLiteConnection(cadenaConexion);
